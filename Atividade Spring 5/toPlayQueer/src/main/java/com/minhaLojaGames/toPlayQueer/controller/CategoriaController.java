...
import com.minhaLojaGames.toPlayQueer.repository.CategoriaRepository;
...
public class CategoriaController {
	...
	@GetMapping("/descricaoCategoria/{descricaoCategoria}")//caminho URI
	public ResponseEntity<List<Categoria>> GetByTitulo(@PathVariable String descricaoCategoria){
